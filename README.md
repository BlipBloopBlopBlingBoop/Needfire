...
- **A citable offline library** — 46 bundled CC0 reference docs (first aid, water, food, fire,
...
- **An offline field toolkit** — water disinfection doses, ORS mixer, field timers, SOS strobe,
  solar sizing, Ohm's-law helpers, wind-chill/heat-index, lightning range, ration planner, and
  pace/declination navigation aids.
...
| [`seed-corpus/`](seed-corpus/) | 46 bundled CC0 reference documents + `seed-manifest.json` (SHA-256 per doc) |
