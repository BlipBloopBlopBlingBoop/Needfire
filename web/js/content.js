...
const Content = (function () {
  ...
  async function home() {
    const wrap = el('div', {}, [
      ...
      el('p', { class: 'muted-note' }, ['The bundled 46-document seed library works offline right now. Add more below — big reference archives (Wikipedia, medical manuals, how-to guides) or your own files. Downloads verify by SHA-256.']),
    ]);
